...
local fg  = hsl(275, 80, 70)  -- Vim has a mapping, <n>C-a and <n>C-x to
local mid = hsl(275, 90, 30)  -- increment or decrement integers, or
local bg  = hsl(275, 90, 10)  -- you can just type them normally.
...
local theme = lush(function()
  return {
    ...
    Whitespace { fg = Normal.bg.desaturate(60).lighten(25) },
    ...
    Comment { fg = Normal.bg.desaturate(60).lighten(25) },

    -- Here's how we might set our line numbers to be relational to Normal,
    -- note we'er also using some shorter aliases here.
    -- (`setlocal number`)
    LineNr       { bg = Normal.bg.da(10), fg = mid.darken(25) }, -- Line number for ":number" and ":#" commands, and when 'number' or 'relativenumber' option is set.
    CursorLineNr { bg = CursorLine.bg, fg = mid.lighten(25), gui = "bold"}, -- Like LineNr when 'cursorline' or 'relativenumber' is set for the cursor line.
    ...
    SearchBase  { bg = Normal.bg.rotate(-90), fg = Normal.fg.rotate(-90) },
    Search       { SearchBase },
    IncSearch    { bg = bg.rotate(-90).darken(50), fg = fg.rotate(-90).darken(50) },
    ...
    Pmenu        { bg = Normal.bg.lighten(15), fg= Normal.fg.darken(25) }, -- Popup menu: normal item.
    PmenuSel     { fg = Pmenu.fg.darken(25), bg = Normal.bg.lighten(5) }, -- Popup menu: selected item.
    PmenuSbar     { fg = Pmenu.fg, bg = Normal.bg.lighten(15) }, -- Popup menu: selected item.
    PmenuThumb     { fg = Pmenu.fg, bg = Normal.bg.lighten(25) }, -- Popup menu: selected item.
    ...
    Visual       { SearchBase }, -- Visual mode selection
    -- VisualNOS    { }, -- Visual mode selection when vim is "Not Owning the Selection".
    WarningMsg   { fg = "#FCD34D" }, -- warning messages
    ErrorMsg   { fg = "#EF4444" }, -- warning messages
    InfoMsg { fg = "#22D3EE" },
    ...
    Literal  {  fg = hsl(353, 30, 50) },
    Constant       { Literal }, -- (preferred) any constant
    String         { Literal }, --   a string constant: "this is a string"
    Character      { Literal }, --  a character constant: 'c', '\n'
    Number         { Literal }, --   a number constant: 234, 0xff
    Boolean        { Literal }, --  a boolean constant: TRUE, false
    Float          { Literal }, --    a floating point constant: 2.3e10

    -- Identifier     { }, -- (preferred) any variable name
    -- Function       { }, -- function name (also: methods for classes)

    Keywords  { fg = "#0EA5E9", gui = "bold" },
    Statement      { Keywords }, -- (preferred) any statement
    Conditional    { Keywords }, --  if, then, else, endif, switch, etc.
    Repeat         { Keywords }, --   for, do, while, etc.
    Label          { Keywords }, --    case, default, etc.
    Operator       { Keywords }, -- "sizeof", "+", "*", etc.
    Keyword        { Keywords }, --  any other keyword
    ...
    Type           { fg = "#14B8A6", gui = "bold" }, -- (preferred) int, long, char, etc.
    ...
    LspDiagnosticsError               { ErrorMsg }, -- used for "Error" diagnostic virtual text
    LspDiagnosticsErrorSign           { ErrorMsg }, -- used for "Error" diagnostic signs in sign column
    LspDiagnosticsErrorFloating       { ErrorMsg }, -- used for "Error" diagnostic messages in the diagnostics float
    LspDiagnosticsWarning             { WarningMsg }, -- used for "Warning" diagnostic virtual text
    LspDiagnosticsWarningSign         { WarningMsg }, -- used for "Warning" diagnostic signs in sign column
    ...
    LspDiagnosticsInformation         { InfoMsg }, -- used for "Information" diagnostic virtual text
    LspDiagnosticsInformationSign     { InfoMsg }, -- used for "Information" signs in sign column
    LspDiagnosticsInformationFloating { InfoMsg }, -- used for "Information" diagnostic messages in the diagnostics float
    LspDiagnosticsHint                { InfoMsg }, -- used for "Hint" diagnostic virtual text
    LspDiagnosticsHintSign            { InfoMsg }, -- used for "Hint" diagnostic signs in sign column
    LspDiagnosticsHintFloating        { InfoMsg }, -- used for "Hint" diagnostic messages in the diagnostics float
    LspReferenceText                  { InfoMsg }, -- used for highlighting "text" references
    LspReferenceRead                  { InfoMsg }, -- used for highlighting "read" references
    LspReferenceWrite                 { InfoMsg }, -- used for highlighting "write" references
